...
class NeuralNetwork{
  ...
  constructor(a,b,c) {
    //overloading a constructor is writing two types of constructur
  ...
  //adding functions for neuroEvolution

  copy() {
    // what we do here is pass again the object through the constructor
    //and since the constructor has been overloaded we can create local copies of the object
    //properties
  ...
  mutate(rate){
    ...
    this.weights_ih.map(mutate) // using the maitrix map() not Js's
